const articles = [
  {
    name: "learn-react",
    title: "Singleton",
    thumbnail: "/images/Singleton-Pattern.png",
    content: [
      "Si tratta di uno dei più famosi e più facile design pattern da implementare. "+
      "Viene utilizzato per fare in modo da poter istanziare una sola volta una classe escludendo la possibilità, anche "
      +"erroneamente, di istanziarle altre.",
      "Implementazione"
